        ...
        <div class="container" style=" margin-top: 2%;margin-left: 13%;margin-bottom: 2%;margin-right: 7%; ">
            <div class="alert-success text-center">
                ...
                <div style="color: black; padding:20px; ">
                    ...
                    <p class="lead"><strong>Service: </strong>${requestScope.saloncustomer.serviceType}</p>
                    <p class="lead"><strong>Date: </strong>${requestScope.saloncustomer.date}</p>
                    <p class="lead"><strong>Time: </strong>${requestScope.saloncustomer.time}</p>
                </div></div></div>
